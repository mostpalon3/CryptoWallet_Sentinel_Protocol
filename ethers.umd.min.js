...
(function (global, factory) {
  ...
  class RIPEMD160 extends SHA2 {
    ...
    process(view, offset) {
      ...
      for (let group = 0; group < 5; group++) {
        ...
        for (let i = 0; i < 16; i++) {
          const tr =
            (rotl$1(ar + f(rGroup, br, cr, dr) + BUF[rr[i]] + hbr, sr[i]) +
              er) |
            0;
  ...
  class Signature {
    ...
    static from(sig) {
      ...
      assertError(
        !("yParity" in sig && sig.yParity !== result.yParity),
        "yParity mismatch"
      );
      assertError(
        !("yParityAndS" in sig && sig.yParityAndS !== result.yParityAndS),
  ...
  class EnsResolver {
    ...
    async #fetch(funcName, params) {
      ...
      params.push({ ccipReadEnable: true });
      try {
  ...
  const defaultOptions$1 = { cacheTimeout: 250 };
